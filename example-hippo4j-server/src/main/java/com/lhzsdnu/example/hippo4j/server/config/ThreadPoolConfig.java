package com.lhzsdnu.example.hippo4j.server.config;

import com.lhzsdnu.example.hippo4j.server.util.ThreadPoolUtil;
...
public class ThreadPoolConfig {
    ...
    public ThreadPoolExecutor messageDynamicExecutor() {
        ...
        // 通过 ThreadPoolBuilder 构建动态线程池，只有 threadFactory、threadPoolId 为必填项，其它参数会从服务端拉取
